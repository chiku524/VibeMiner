    ...
    (
      ...
      >
        <svg width="120" height="120" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="ap-gem-main" x1="25%" y1="0%" x2="75%" y2="100%">
              <stop offset="0%" stopColor="#ecfeff" />
              <stop offset="32%" stopColor="#38bdf8" />
              <stop offset="58%" stopColor="#2563eb" />
              <stop offset="100%" stopColor="#047857" />
            </linearGradient>
            <linearGradient id="ap-gem-shade" x1="0%" y1="40%" x2="100%" y2="60%">
              <stop offset="0%" stopColor="#164e63" />
              <stop offset="50%" stopColor="#5eead4" />
              <stop offset="100%" stopColor="#14532d" />
            </linearGradient>
            <linearGradient id="ap-gem-edge" x1="45%" y1="0%" x2="55%" y2="100%">
              <stop offset="0%" stopColor="#bae6fd" />
              <stop offset="100%" stopColor="#0f766e" />
            </linearGradient>
            <linearGradient id="ap-base" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#5c5348" />
              <stop offset="100%" stopColor="#0c0a08" />
            </linearGradient>
            <linearGradient id="ap-base-cap" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#d4bc94" />
              <stop offset="100%" stopColor="#8b6914" />
            </linearGradient>
            <linearGradient id="ap-base-mid" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#4a4238" />
              <stop offset="100%" stopColor="#1a1612" />
            </linearGradient>
            <linearGradient id="ap-handle" gradientUnits="userSpaceOnUse" x1="18.35" y1="24.62" x2="20.98" y2="15.08">
              <stop offset="0%" stopColor="#1a100c" />
              <stop offset="45%" stopColor="#8b5a3c" />
              <stop offset="100%" stopColor="#3d2818" />
            </linearGradient>
            <linearGradient id="ap-steel" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#e2e8f0" />
              <stop offset="35%" stopColor="#94a3b8" />
              <stop offset="100%" stopColor="#0f172a" />
            </linearGradient>
            <linearGradient id="ap-eye-rim" x1="20%" y1="0%" x2="80%" y2="100%">
              <stop offset="0%" stopColor="#f8fafc" />
              <stop offset="50%" stopColor="#64748b" />
              <stop offset="100%" stopColor="#020617" />
            </linearGradient>
            <linearGradient id="ap-wood-socket" x1="40%" y1="0%" x2="60%" y2="100%">
              <stop offset="0%" stopColor="#e8dcc8" />
              <stop offset="55%" stopColor="#78716c" />
              <stop offset="100%" stopColor="#292524" />
            </linearGradient>
          </defs>
          <path d="M3.85 27.35h14.5v2.25H3.85z" fill="url(#ap-base-mid)" stroke="#2a2520" strokeWidth="0.22" />
          <path d="M4 26.35h13.35v2.35H4z" fill="url(#ap-base)" stroke="#3d3530" strokeWidth="0.24" />
          <path d="M4 26.35l0.5-0.42h12.35l0.5 0.42z" fill="url(#ap-base-cap)" opacity={0.92} />
          ...
          <path d="M18.35 24.62L20.98 15.08" stroke="url(#ap-handle)" strokeWidth="1.22" strokeLinecap="round" fill="none" />
          <path
